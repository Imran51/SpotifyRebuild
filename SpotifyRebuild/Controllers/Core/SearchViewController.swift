...
class SearchViewController: UIViewController {
    ...
    private let collectionView: UICollectionView = UICollectionView(frame: .zero, collectionViewLayout: UICollectionViewCompositionalLayout(sectionProvider: { (_,_) -> NSCollectionLayoutSection? in
        return SearchViewController.createCollectionViewSectionLayout()
    }))
    ...
    override func viewDidLoad() {
        ...
        initializeCollectionViewAndSearchBar()
        fetchSearchCategory()
    }
    
    private func initializeCollectionViewAndSearchBar() {
...
// MARK:- UISearchController delegate implementation
...
// MARK:- Search Results ViewController Delegate implementation
